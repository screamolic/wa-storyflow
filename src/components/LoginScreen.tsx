  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] flex items-center justify-center p-4">
      ...
      >
        ...
        <h1 className="text-2xl font-bold mb-2">Akses StoryFlow</h1>
        <p className="text-gray-500 mb-8 text-sm">
          Login dengan akun Google untuk menyimpan konfigurasi WhatsApp Anda.
        </p>
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 text-gray-700 p-4 rounded-2xl font-bold hover:bg-gray-50 transition-all shadow-sm"
          >
